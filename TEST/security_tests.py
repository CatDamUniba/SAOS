...
USERNAME = "test_user"      # Cambia con un utente admin reale
PASSWORD = "gfg123"         # Cambia con la password reale
SECRET_KEY = "aldoaldoaldoaldoaldoaldoaldoaldoaldoaldo"  # Deve corrispondere alla tua jwtSecret se usi HS512
...
def get_valid_jwt():
    ...
    if res.status_code == 200:
        ...
        print("KO Login fallito:", res.status_code, res.text)
        return None
...
def test_token(token, description):
    ...
    if res.status_code == 200:
        ...
        print("KO Accesso negato:", res.text[:200])

def main():
    # ignora tutte le warning presenti di tipo deprecation per rendere più pulito l'esito dei test
    ...
    none_token = "eyJhbGciOiJub25lIn0.eyJzdWIiOiAidGVzdFVzZXIifQ."
